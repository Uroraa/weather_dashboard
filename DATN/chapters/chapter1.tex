...
bài toán thông qua phân tích các hệ thống quan trắc môi trường hiện có, tích
hợp các nghiên cứu liên quan và các nguồn tài liệu ngoài đầy đủ. Trên cơ sở
khảo sát, các chức năng cốt lõi của hệ thống được xác định và biểu diễn qua
biểu đồ use case kèm đặc tả chi tiết.

\textbf{Chương~\ref{chap:design}} trình bày chi tiết quá trình thiết
kế và triển khai hệ thống, bao gồm phân tích lựa chọn công nghệ đi kèm chi tiết
về từng cấu phần triển khai phần cứng, thiết kế firmware, thiết kế cơ sở dữ
liệu, thiết kế API backend, mô hình học sâu dự báo và trực quan hóa dashboard.

\textbf{Chương~\ref{chap:contribution}} tập trung vào đánh giá hệ thống thông qua kết
quả thực tế, các thử nghiệm kiểm thử chức năng và đánh giá chi tiết ba giải
pháp kỹ thuật nổi bật: pipeline dự báo chuỗi thời gian LSTM phục vụ qua API độc
lập, cơ chế nội suy không gian Kriging/IDW tạo bản đồ nhiệt thời gian thực,
và hạ tầng truyền thông tối ưu hóa độ trễ qua MQTT kết hợp WebSockets.
...
hướng phát triển trong tương lai nhằm nâng cấp và hoàn thiện hệ thống.
